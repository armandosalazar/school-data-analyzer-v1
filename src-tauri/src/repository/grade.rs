...
impl Repository<Grade> for GradeRepository<'_> {
    ...
    fn find_all(&mut self, offset: Option<i64>, page_size: Option<i64>, sort_field: Option<String>, sort_order: Option<i64>, filters: Option<String>) -> Result<Vec<Grade>, Box<dyn Error>> {
        todo!()
    }
}
